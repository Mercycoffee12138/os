...
obj/__user_cow_test_new.out:     file format elf64-littleriscv
...
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80003a:	a2250513          	addi	a0,a0,-1502 # 800a58 <main+0x4f8>
__panic(const char *file, int line, const char *fmt, ...) {
  ...
  80005a:	1ea50513          	addi	a0,a0,490 # 801240 <error_string+0x560>
...
exit(int error_code) {
  ...
  80013a:	94250513          	addi	a0,a0,-1726 # 800a78 <main+0x518>
...
getpid(void) {
    return sys_getpid();
  800148:	bff1                	j	800124 <sys_getpid>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800194:	90078793          	addi	a5,a5,-1792 # 800a90 <main+0x530>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001f0:	8d8a8a93          	addi	s5,s5,-1832 # 800ac4 <main+0x564>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001f8:	aecb8b93          	addi	s7,s7,-1300 # 800ce0 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  80044e:	67660613          	addi	a2,a2,1654 # 800ac0 <main+0x560>
  ...
  800460:	65460613          	addi	a2,a2,1620 # 800ab0 <main+0x550>
  ...
  800472:	63a40413          	addi	s0,s0,1594 # 800aa8 <main+0x548>
  ...
  8004fc:	5b040413          	addi	s0,s0,1456 # 800aa8 <main+0x548>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  800512:	59ba0a13          	addi	s4,s4,1435 # 800aa9 <main+0x549>
...
main(void) {
  ...
  800566:	84650513          	addi	a0,a0,-1978 # 800da8 <error_string+0xc8>
main(void) {
  80056a:	e0a2                	sd	s0,64(sp)
  80056c:	f84a                	sd	s2,48(sp)
  80056e:	00002417          	auipc	s0,0x2
  800572:	a9240413          	addi	s0,s0,-1390 # 802000 <data>
  800576:	e486                	sd	ra,72(sp)
  800578:	fc26                	sd	s1,56(sp)
  80057a:	f44e                	sd	s3,40(sp)
  80057c:	f052                	sd	s4,32(sp)
  80057e:	ec56                	sd	s5,24(sp)
    cprintf("==== COW (Copy-on-Write) Test ====\n\n");
  800580:	b23ff0ef          	jal	ra,8000a2 <cprintf>
  800584:	8922                	mv	s2,s0
  800586:	8722                	mv	a4,s0
    
    // 初始化数据
    int i;
    for (i = 0; i < 1024; i++) {
  800588:	4781                	li	a5,0
  80058a:	40000693          	li	a3,1024
        data[i] = i;
  80058e:	c31c                	sw	a5,0(a4)
    for (i = 0; i < 1024; i++) {
  800590:	2785                	addiw	a5,a5,1
  800592:	0711                	addi	a4,a4,4
  800594:	fed79de3          	bne	a5,a3,80058e <main+0x2e>
    }
    
    cprintf("[TEST 1] Basic COW - Parent and Child\n");
  800598:	00001517          	auipc	a0,0x1
  80059c:	83850513          	addi	a0,a0,-1992 # 800dd0 <error_string+0xf0>
  8005a0:	b03ff0ef          	jal	ra,8000a2 <cprintf>
    int pid = fork();
  8005a4:	ba1ff0ef          	jal	ra,800144 <fork>
  8005a8:	84aa                	mv	s1,a0
    
    if (pid == 0) {
  8005aa:	16050763          	beqz	a0,800718 <main+0x1b8>
        assert(data[0] == 999);
  ...
  8005ae:	44a05d63          	blez	a0,800a08 <main+0x4a8>
        // 父进程等待子进程
        cprintf("[PARENT] Waiting for child...\n");
  8005b2:	00001517          	auipc	a0,0x1
  8005b6:	93650513          	addi	a0,a0,-1738 # 800ee8 <error_string+0x208>
  8005ba:	ae9ff0ef          	jal	ra,8000a2 <cprintf>
        assert(waitpid(pid, NULL) == 0);
  8005be:	4581                	li	a1,0
  8005c0:	8526                	mv	a0,s1
  8005c2:	b85ff0ef          	jal	ra,800146 <waitpid>
  8005c6:	42051163          	bnez	a0,8009e8 <main+0x488>
        
        // 验证父进程的数据未被修改
        cprintf("[PARENT] After child exit: data[0]=%d (expected 0)\n", data[0]);
  8005ca:	00092583          	lw	a1,0(s2)
  8005ce:	00001517          	auipc	a0,0x1
  8005d2:	95250513          	addi	a0,a0,-1710 # 800f20 <error_string+0x240>
  8005d6:	acdff0ef          	jal	ra,8000a2 <cprintf>
        assert(data[0] == 0);
  8005da:	00092983          	lw	s3,0(s2)
  8005de:	2c099e63          	bnez	s3,8008ba <main+0x35a>
        
        cprintf("[PARENT] COW Protection OK\n\n");
  8005e2:	00001517          	auipc	a0,0x1
  8005e6:	97650513          	addi	a0,a0,-1674 # 800f58 <error_string+0x278>
  ...
  8005ee:	00001517          	auipc	a0,0x1
  8005f2:	98a50513          	addi	a0,a0,-1654 # 800f78 <error_string+0x298>
  8005f6:	aadff0ef          	jal	ra,8000a2 <cprintf>
    int child_pids[3];
    
    // 初始化
    for (i = 0; i < 3; i++) {
        data[i] = 100 + i;
  8005fa:	06500793          	li	a5,101
  8005fe:	1782                	slli	a5,a5,0x20
  800600:	06478793          	addi	a5,a5,100
  800604:	848a                	mv	s1,sp
  800606:	00f93023          	sd	a5,0(s2)
  80060a:	06600793          	li	a5,102
  80060e:	00f92423          	sw	a5,8(s2)
  800612:	8a26                	mv	s4,s1
    }
    
    for (i = 0; i < 3; i++) {
  800614:	4a8d                	li	s5,3
        int p = fork();
  800616:	b2fff0ef          	jal	ra,800144 <fork>
        if (p == 0) {
  80061a:	1c050f63          	beqz	a0,8007f8 <main+0x298>
  ...
  80061e:	40a05163          	blez	a0,800a20 <main+0x4c0>
            child_pids[i] = p;
  800622:	00aa2023          	sw	a0,0(s4)
    for (i = 0; i < 3; i++) {
  800626:	2985                	addiw	s3,s3,1
  800628:	0a11                	addi	s4,s4,4
  80062a:	ff5996e3          	bne	s3,s5,800616 <main+0xb6>
  80062e:	00c48a93          	addi	s5,s1,12
        }
    }
  ...
  800632:	00001a17          	auipc	s4,0x1
  800636:	9c6a0a13          	addi	s4,s4,-1594 # 800ff8 <error_string+0x318>
  80063a:	0004a983          	lw	s3,0(s1)
  80063e:	8552                	mv	a0,s4
  800640:	85ce                	mv	a1,s3
  800642:	a61ff0ef          	jal	ra,8000a2 <cprintf>
        assert(waitpid(child_pids[i], NULL) == 0);
  800646:	4581                	li	a1,0
  800648:	854e                	mv	a0,s3
  80064a:	afdff0ef          	jal	ra,800146 <waitpid>
  80064e:	2a051663          	bnez	a0,8008fa <main+0x39a>
    for (i = 0; i < 3; i++) {
  800652:	0491                	addi	s1,s1,4
  800654:	fe9a93e3          	bne	s5,s1,80063a <main+0xda>
  800658:	06400493          	li	s1,100
    }
    
    // 验证父进程数据保持不变
    for (i = 0; i < 3; i++) {
        cprintf("[PARENT] data[%d]=%d (expected %d)\n", i, data[i], 100 + i);
  80065c:	00001a97          	auipc	s5,0x1
  800660:	9e4a8a93          	addi	s5,s5,-1564 # 801040 <error_string+0x360>
    for (i = 0; i < 3; i++) {
  800664:	06700a13          	li	s4,103
        cprintf("[PARENT] data[%d]=%d (expected %d)\n", i, data[i], 100 + i);
  800668:	4010                	lw	a2,0(s0)
  80066a:	0004899b          	sext.w	s3,s1
  80066e:	86ce                	mv	a3,s3
  800670:	f9c4859b          	addiw	a1,s1,-100
  800674:	8556                	mv	a0,s5
  800676:	a2dff0ef          	jal	ra,8000a2 <cprintf>
        assert(data[i] == 100 + i);
  80067a:	401c                	lw	a5,0(s0)
  80067c:	3b379e63          	bne	a5,s3,800a38 <main+0x4d8>
    for (i = 0; i < 3; i++) {
  800680:	2485                	addiw	s1,s1,1
  800682:	0411                	addi	s0,s0,4
  800684:	ff4492e3          	bne	s1,s4,800668 <main+0x108>
    }
    
    cprintf("[PARENT] All children isolated OK\n\n");
  800688:	00001517          	auipc	a0,0x1
  80068c:	9f850513          	addi	a0,a0,-1544 # 801080 <error_string+0x3a0>
  800690:	a13ff0ef          	jal	ra,8000a2 <cprintf>
    
    // TEST 3: 嵌套 fork
    cprintf("[TEST 3] Nested Fork COW\n");
  800694:	00001517          	auipc	a0,0x1
  800698:	a1450513          	addi	a0,a0,-1516 # 8010a8 <error_string+0x3c8>
  80069c:	a07ff0ef          	jal	ra,8000a2 <cprintf>
    
    data[0] = 50;
  8006a0:	03300413          	li	s0,51
  8006a4:	02041793          	slli	a5,s0,0x20
  8006a8:	03278793          	addi	a5,a5,50
  8006ac:	00f93023          	sd	a5,0(s2)
    data[1] = 51;
    
    int pid1 = fork();
  8006b0:	a95ff0ef          	jal	ra,800144 <fork>
    if (pid1 == 0) {
  8006b4:	c179                	beqz	a0,80077a <main+0x21a>
            exit(0);
        } else {
            panic("fork failed");
        }
  ...
  8006b6:	26a05263          	blez	a0,80091a <main+0x3ba>
        assert(waitpid(pid1, NULL) == 0);
  8006ba:	4581                	li	a1,0
  8006bc:	a8bff0ef          	jal	ra,800146 <waitpid>
  8006c0:	26051963          	bnez	a0,800932 <main+0x3d2>
        
        // 验证父进程数据未被修改
        cprintf("[PARENT] After nested fork: data[0]=%d, data[1]=%d\n",
  8006c4:	00492603          	lw	a2,4(s2)
  8006c8:	00092583          	lw	a1,0(s2)
  8006cc:	00001517          	auipc	a0,0x1
  8006d0:	b1450513          	addi	a0,a0,-1260 # 8011e0 <error_string+0x500>
  8006d4:	9cfff0ef          	jal	ra,8000a2 <cprintf>
                data[0], data[1]);
        assert(data[0] == 50);
  8006d8:	00092703          	lw	a4,0(s2)
  8006dc:	03200793          	li	a5,50
  8006e0:	26f71963          	bne	a4,a5,800952 <main+0x3f2>
        assert(data[1] == 51);
  8006e4:	00492783          	lw	a5,4(s2)
  8006e8:	1e879963          	bne	a5,s0,8008da <main+0x37a>
        cprintf("[PARENT] Nested fork OK\n\n");
  8006ec:	00001517          	auipc	a0,0x1
  8006f0:	b3c50513          	addi	a0,a0,-1220 # 801228 <error_string+0x548>
  ...
  8006fc:	b5050513          	addi	a0,a0,-1200 # 801248 <error_string+0x568>
  800700:	9a3ff0ef          	jal	ra,8000a2 <cprintf>
    return 0;
}
  800704:	60a6                	ld	ra,72(sp)
  800706:	6406                	ld	s0,64(sp)
  800708:	74e2                	ld	s1,56(sp)
  80070a:	7942                	ld	s2,48(sp)
  80070c:	79a2                	ld	s3,40(sp)
  80070e:	7a02                	ld	s4,32(sp)
  800710:	6ae2                	ld	s5,24(sp)
  800712:	4501                	li	a0,0
  800714:	6161                	addi	sp,sp,80
  800716:	8082                	ret
        cprintf("[CHILD] Checking initial value: data[0]=%d (expected 0)\n", data[0]);
  800718:	00092583          	lw	a1,0(s2)
  80071c:	00000517          	auipc	a0,0x0
  800720:	6dc50513          	addi	a0,a0,1756 # 800df8 <error_string+0x118>
  800724:	97fff0ef          	jal	ra,8000a2 <cprintf>
        assert(data[0] == 0);
  800728:	00092783          	lw	a5,0(s2)
  80072c:	24079363          	bnez	a5,800972 <main+0x412>
        cprintf("[CHILD] Writing data[0]=999...\n");
  800730:	00000517          	auipc	a0,0x0
  800734:	74850513          	addi	a0,a0,1864 # 800e78 <error_string+0x198>
  800738:	96bff0ef          	jal	ra,8000a2 <cprintf>
        data[0] = 999;
  80073c:	3e700413          	li	s0,999
        cprintf("[CHILD] After write: data[0]=%d\n", data[0]);
  800740:	3e700593          	li	a1,999
  800744:	00000517          	auipc	a0,0x0
  800748:	75450513          	addi	a0,a0,1876 # 800e98 <error_string+0x1b8>
        data[0] = 999;
  80074c:	00892023          	sw	s0,0(s2)
        cprintf("[CHILD] After write: data[0]=%d\n", data[0]);
  800750:	953ff0ef          	jal	ra,8000a2 <cprintf>
        assert(data[0] == 999);
  800754:	00092783          	lw	a5,0(s2)
  800758:	08878763          	beq	a5,s0,8007e6 <main+0x286>
  80075c:	00000697          	auipc	a3,0x0
  800760:	76468693          	addi	a3,a3,1892 # 800ec0 <error_string+0x1e0>
  800764:	00000617          	auipc	a2,0x0
  800768:	6e460613          	addi	a2,a2,1764 # 800e48 <error_string+0x168>
  80076c:	45fd                	li	a1,31
  80076e:	00000517          	auipc	a0,0x0
  800772:	6f250513          	addi	a0,a0,1778 # 800e60 <error_string+0x180>
  800776:	8b1ff0ef          	jal	ra,800026 <__panic>
        cprintf("[L1-CHILD] Modifying data[0]=150\n");
  80077a:	00001517          	auipc	a0,0x1
  80077e:	94e50513          	addi	a0,a0,-1714 # 8010c8 <error_string+0x3e8>
        data[0] = 150;
  800782:	09600493          	li	s1,150
        cprintf("[L1-CHILD] Modifying data[0]=150\n");
  800786:	91dff0ef          	jal	ra,8000a2 <cprintf>
        data[0] = 150;
  80078a:	00992023          	sw	s1,0(s2)
        int pid2 = fork();
  80078e:	9b7ff0ef          	jal	ra,800144 <fork>
        if (pid2 == 0) {
  800792:	c561                	beqz	a0,80085a <main+0x2fa>
        } else if (pid2 > 0) {
  800794:	22a05e63          	blez	a0,8009d0 <main+0x470>
            assert(waitpid(pid2, NULL) == 0);
  800798:	4581                	li	a1,0
  80079a:	9adff0ef          	jal	ra,800146 <waitpid>
  80079e:	20051963          	bnez	a0,8009b0 <main+0x450>
            cprintf("[L1-CHILD] After L2-CHILD: data[0]=%d, data[1]=%d\n", 
  8007a2:	00492603          	lw	a2,4(s2)
  8007a6:	00092583          	lw	a1,0(s2)
  8007aa:	00001517          	auipc	a0,0x1
  8007ae:	9b650513          	addi	a0,a0,-1610 # 801160 <error_string+0x480>
  8007b2:	8f1ff0ef          	jal	ra,8000a2 <cprintf>
            assert(data[0] == 150);
  8007b6:	00092783          	lw	a5,0(s2)
  8007ba:	1c979b63          	bne	a5,s1,800990 <main+0x430>
            assert(data[1] == 51);  // 未被修改
  8007be:	00492783          	lw	a5,4(s2)
  8007c2:	0e878363          	beq	a5,s0,8008a8 <main+0x348>
  8007c6:	00001697          	auipc	a3,0x1
  8007ca:	9d268693          	addi	a3,a3,-1582 # 801198 <error_string+0x4b8>
  8007ce:	00000617          	auipc	a2,0x0
  8007d2:	67a60613          	addi	a2,a2,1658 # 800e48 <error_string+0x168>
  8007d6:	07b00593          	li	a1,123
  8007da:	00000517          	auipc	a0,0x0
  8007de:	68650513          	addi	a0,a0,1670 # 800e60 <error_string+0x180>
  8007e2:	845ff0ef          	jal	ra,800026 <__panic>
        cprintf("[CHILD] Exit OK\n");
  8007e6:	00000517          	auipc	a0,0x0
  8007ea:	6ea50513          	addi	a0,a0,1770 # 800ed0 <error_string+0x1f0>
  8007ee:	8b5ff0ef          	jal	ra,8000a2 <cprintf>
        exit(0);
  8007f2:	4501                	li	a0,0
  8007f4:	93bff0ef          	jal	ra,80012e <exit>
            cprintf("[CHILD %d] Modifying data[%d]\n", getpid(), idx);
  8007f8:	951ff0ef          	jal	ra,800148 <getpid>
  8007fc:	85aa                	mv	a1,a0
  8007fe:	864e                	mv	a2,s3
  800800:	00000517          	auipc	a0,0x0
  800804:	7a850513          	addi	a0,a0,1960 # 800fa8 <error_string+0x2c8>
  800808:	89bff0ef          	jal	ra,8000a2 <cprintf>
            data[idx] = 1000 + idx;
  80080c:	00299793          	slli	a5,s3,0x2
  800810:	993e                	add	s2,s2,a5
  800812:	3e89841b          	addiw	s0,s3,1000
  800816:	00892023          	sw	s0,0(s2)
            cprintf("[CHILD %d] data[%d]=%d\n", getpid(), idx, data[idx]);
  80081a:	92fff0ef          	jal	ra,800148 <getpid>
  80081e:	00092683          	lw	a3,0(s2)
  800822:	85aa                	mv	a1,a0
  800824:	864e                	mv	a2,s3
  800826:	00000517          	auipc	a0,0x0
  80082a:	7a250513          	addi	a0,a0,1954 # 800fc8 <error_string+0x2e8>
  80082e:	875ff0ef          	jal	ra,8000a2 <cprintf>
            assert(data[idx] == 1000 + idx);
  800832:	00092783          	lw	a5,0(s2)
  800836:	06878663          	beq	a5,s0,8008a2 <main+0x342>
  80083a:	00000697          	auipc	a3,0x0
  80083e:	7a668693          	addi	a3,a3,1958 # 800fe0 <error_string+0x300>
  800842:	00000617          	auipc	a2,0x0
  800846:	60660613          	addi	a2,a2,1542 # 800e48 <error_string+0x168>
  80084a:	04500593          	li	a1,69
  80084e:	00000517          	auipc	a0,0x0
  800852:	61250513          	addi	a0,a0,1554 # 800e60 <error_string+0x180>
  800856:	fd0ff0ef          	jal	ra,800026 <__panic>
            cprintf("[L2-CHILD] Modifying data[1]=250\n");
  80085a:	00001517          	auipc	a0,0x1
  80085e:	89650513          	addi	a0,a0,-1898 # 8010f0 <error_string+0x410>
  800862:	841ff0ef          	jal	ra,8000a2 <cprintf>
            assert(data[0] == 150);
  800866:	00092783          	lw	a5,0(s2)
            data[1] = 250;
  80086a:	0fa00713          	li	a4,250
  80086e:	00e92223          	sw	a4,4(s2)
            assert(data[0] == 150);
  800872:	02978263          	beq	a5,s1,800896 <main+0x336>
  800876:	00001697          	auipc	a3,0x1
  80087a:	8a268693          	addi	a3,a3,-1886 # 801118 <error_string+0x438>
  80087e:	00000617          	auipc	a2,0x0
  800882:	5ca60613          	addi	a2,a2,1482 # 800e48 <error_string+0x168>
  800886:	06f00593          	li	a1,111
  80088a:	00000517          	auipc	a0,0x0
  80088e:	5d650513          	addi	a0,a0,1494 # 800e60 <error_string+0x180>
  800892:	f94ff0ef          	jal	ra,800026 <__panic>
            cprintf("[L2-CHILD] Exit OK\n");
  800896:	00001517          	auipc	a0,0x1
  80089a:	89250513          	addi	a0,a0,-1902 # 801128 <error_string+0x448>
  80089e:	805ff0ef          	jal	ra,8000a2 <cprintf>
            exit(0);
  8008a2:	4501                	li	a0,0
  8008a4:	88bff0ef          	jal	ra,80012e <exit>
            cprintf("[L1-CHILD] Exit OK\n");
  8008a8:	00001517          	auipc	a0,0x1
  8008ac:	90050513          	addi	a0,a0,-1792 # 8011a8 <error_string+0x4c8>
  8008b0:	ff2ff0ef          	jal	ra,8000a2 <cprintf>
            exit(0);
  8008b4:	4501                	li	a0,0
  8008b6:	879ff0ef          	jal	ra,80012e <exit>
        assert(data[0] == 0);
  8008ba:	00000697          	auipc	a3,0x0
  8008be:	57e68693          	addi	a3,a3,1406 # 800e38 <error_string+0x158>
  8008c2:	00000617          	auipc	a2,0x0
  8008c6:	58660613          	addi	a2,a2,1414 # 800e48 <error_string+0x168>
  8008ca:	02b00593          	li	a1,43
  8008ce:	00000517          	auipc	a0,0x0
  8008d2:	59250513          	addi	a0,a0,1426 # 800e60 <error_string+0x180>
  8008d6:	f50ff0ef          	jal	ra,800026 <__panic>
        assert(data[1] == 51);
  8008da:	00001697          	auipc	a3,0x1
  8008de:	8be68693          	addi	a3,a3,-1858 # 801198 <error_string+0x4b8>
  8008e2:	00000617          	auipc	a2,0x0
  8008e6:	56660613          	addi	a2,a2,1382 # 800e48 <error_string+0x168>
  8008ea:	08900593          	li	a1,137
  8008ee:	00000517          	auipc	a0,0x0
  8008f2:	57250513          	addi	a0,a0,1394 # 800e60 <error_string+0x180>
  8008f6:	f30ff0ef          	jal	ra,800026 <__panic>
        assert(waitpid(child_pids[i], NULL) == 0);
  8008fa:	00000697          	auipc	a3,0x0
  8008fe:	71e68693          	addi	a3,a3,1822 # 801018 <error_string+0x338>
  800902:	00000617          	auipc	a2,0x0
  800906:	54660613          	addi	a2,a2,1350 # 800e48 <error_string+0x168>
  80090a:	05200593          	li	a1,82
  80090e:	00000517          	auipc	a0,0x0
  800912:	55250513          	addi	a0,a0,1362 # 800e60 <error_string+0x180>
  800916:	f10ff0ef          	jal	ra,800026 <__panic>
        panic("fork failed");
  80091a:	00000617          	auipc	a2,0x0
  80091e:	67e60613          	addi	a2,a2,1662 # 800f98 <error_string+0x2b8>
  800922:	08d00593          	li	a1,141
  800926:	00000517          	auipc	a0,0x0
  80092a:	53a50513          	addi	a0,a0,1338 # 800e60 <error_string+0x180>
  80092e:	ef8ff0ef          	jal	ra,800026 <__panic>
        assert(waitpid(pid1, NULL) == 0);
  800932:	00001697          	auipc	a3,0x1
  800936:	88e68693          	addi	a3,a3,-1906 # 8011c0 <error_string+0x4e0>
  80093a:	00000617          	auipc	a2,0x0
  80093e:	50e60613          	addi	a2,a2,1294 # 800e48 <error_string+0x168>
  800942:	08300593          	li	a1,131
  800946:	00000517          	auipc	a0,0x0
  80094a:	51a50513          	addi	a0,a0,1306 # 800e60 <error_string+0x180>
  80094e:	ed8ff0ef          	jal	ra,800026 <__panic>
        assert(data[0] == 50);
  800952:	00001697          	auipc	a3,0x1
  800956:	8c668693          	addi	a3,a3,-1850 # 801218 <error_string+0x538>
  80095a:	00000617          	auipc	a2,0x0
  80095e:	4ee60613          	addi	a2,a2,1262 # 800e48 <error_string+0x168>
  800962:	08800593          	li	a1,136
  800966:	00000517          	auipc	a0,0x0
  80096a:	4fa50513          	addi	a0,a0,1274 # 800e60 <error_string+0x180>
  80096e:	eb8ff0ef          	jal	ra,800026 <__panic>
        assert(data[0] == 0);
  800972:	00000697          	auipc	a3,0x0
  800976:	4c668693          	addi	a3,a3,1222 # 800e38 <error_string+0x158>
  80097a:	00000617          	auipc	a2,0x0
  80097e:	4ce60613          	addi	a2,a2,1230 # 800e48 <error_string+0x168>
  800982:	45e1                	li	a1,24
  800984:	00000517          	auipc	a0,0x0
  800988:	4dc50513          	addi	a0,a0,1244 # 800e60 <error_string+0x180>
  80098c:	e9aff0ef          	jal	ra,800026 <__panic>
            assert(data[0] == 150);
  800990:	00000697          	auipc	a3,0x0
  800994:	78868693          	addi	a3,a3,1928 # 801118 <error_string+0x438>
  800998:	00000617          	auipc	a2,0x0
  80099c:	4b060613          	addi	a2,a2,1200 # 800e48 <error_string+0x168>
  8009a0:	07a00593          	li	a1,122
  8009a4:	00000517          	auipc	a0,0x0
  8009a8:	4bc50513          	addi	a0,a0,1212 # 800e60 <error_string+0x180>
  8009ac:	e7aff0ef          	jal	ra,800026 <__panic>
            assert(waitpid(pid2, NULL) == 0);
  8009b0:	00000697          	auipc	a3,0x0
  8009b4:	79068693          	addi	a3,a3,1936 # 801140 <error_string+0x460>
  8009b8:	00000617          	auipc	a2,0x0
  8009bc:	49060613          	addi	a2,a2,1168 # 800e48 <error_string+0x168>
  8009c0:	07500593          	li	a1,117
  8009c4:	00000517          	auipc	a0,0x0
  8009c8:	49c50513          	addi	a0,a0,1180 # 800e60 <error_string+0x180>
  8009cc:	e5aff0ef          	jal	ra,800026 <__panic>
            panic("fork failed");
  8009d0:	00000617          	auipc	a2,0x0
  8009d4:	5c860613          	addi	a2,a2,1480 # 800f98 <error_string+0x2b8>
  8009d8:	07f00593          	li	a1,127
  8009dc:	00000517          	auipc	a0,0x0
  8009e0:	48450513          	addi	a0,a0,1156 # 800e60 <error_string+0x180>
  8009e4:	e42ff0ef          	jal	ra,800026 <__panic>
        assert(waitpid(pid, NULL) == 0);
  8009e8:	00000697          	auipc	a3,0x0
  8009ec:	52068693          	addi	a3,a3,1312 # 800f08 <error_string+0x228>
  8009f0:	00000617          	auipc	a2,0x0
  8009f4:	45860613          	addi	a2,a2,1112 # 800e48 <error_string+0x168>
  8009f8:	02700593          	li	a1,39
  8009fc:	00000517          	auipc	a0,0x0
  800a00:	46450513          	addi	a0,a0,1124 # 800e60 <error_string+0x180>
  800a04:	e22ff0ef          	jal	ra,800026 <__panic>
        panic("fork failed");
  800a08:	00000617          	auipc	a2,0x0
  800a0c:	59060613          	addi	a2,a2,1424 # 800f98 <error_string+0x2b8>
  800a10:	03000593          	li	a1,48
  800a14:	00000517          	auipc	a0,0x0
  800a18:	44c50513          	addi	a0,a0,1100 # 800e60 <error_string+0x180>
  800a1c:	e0aff0ef          	jal	ra,800026 <__panic>
            panic("fork failed");
  800a20:	00000617          	auipc	a2,0x0
  800a24:	57860613          	addi	a2,a2,1400 # 800f98 <error_string+0x2b8>
  800a28:	04b00593          	li	a1,75
  800a2c:	00000517          	auipc	a0,0x0
  800a30:	43450513          	addi	a0,a0,1076 # 800e60 <error_string+0x180>
  800a34:	df2ff0ef          	jal	ra,800026 <__panic>
        assert(data[i] == 100 + i);
  800a38:	00000697          	auipc	a3,0x0
  800a3c:	63068693          	addi	a3,a3,1584 # 801068 <error_string+0x388>
  800a40:	00000617          	auipc	a2,0x0
  800a44:	40860613          	addi	a2,a2,1032 # 800e48 <error_string+0x168>
  800a48:	05800593          	li	a1,88
  800a4c:	00000517          	auipc	a0,0x0
  800a50:	41450513          	addi	a0,a0,1044 # 800e60 <error_string+0x180>
  800a54:	dd2ff0ef          	jal	ra,800026 <__panic>
